(() => {
    ...
    function initSliders() {
        if (document.querySelector(".section-01__slider")) var swiper = new Swiper(".section-01__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                ...
                slideChange: function() {
                    ...
                    var sectionBody = this.el.closest(".section-01__body");
    ...
    class FullPage {
        ...
        setEvents() {
            ...
            if (btnNextSect00) btnNextSect00.addEventListener("click", (() => {
                this.switchingSection(1);
            }));
            if (btnScrollSect00) btnScrollSect00.addEventListener("click", (() => {
                this.switchingSection(1);
            }));
        }
        removeEvents() {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        setTimeout(addBusActiveClass, 3e3);
    }));
    window["FLS"] = false;
    isWebp();
    addLoadedClass();
